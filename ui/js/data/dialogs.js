...
dialogs["select-mask"] = { title: "Select and Mask", width: 420, fields: [rng("Radius:", 10), chk("Smart Radius", true), rng("Smooth:", 0), rng("Feather:", 0), rng("Contrast:", 0), rng("Shift Edge:", 0)], ok: "OK", cancel: "Cancel" };
...
dialogs["generative-fill"] = dialogs.generate;
dialogs["prefs-ai"] = { title: "Preferences — AI Models & ComfyUI", width: 560, fields: [lbl("Models: BiRefNet (Select Subject), EfficientSAM (Object Selection) — downloaded on first use."), txt("ComfyUI address:", "http://127.0.0.1:8000"), txt("Checkpoint:", "")], ok: "OK", cancel: "Cancel" };
dialogs["color-picker"] = { title: "Colour Picker", width: 420, icon: "i-color", fields: [{ type: "colorpicker" }], ok: "OK", cancel: "Cancel" };
dialogs.fill = { title: "Fill", width: 380, fields: [sel("Use:", ["Foreground Colour", "Background Colour", "Content-Aware", "Pattern", "Black", "White", "50% Grey"], "Foreground Colour"), sel("Mode:", ["Normal", "Darken", "Multiply", "Color Burn", "Linear Burn", "Lighten", "Screen", "Color Dodge", "Linear Dodge", "Overlay", "Soft Light", "Hard Light", "Difference", "Exclusion", "Hue", "Saturation", "Color", "Luminosity"], "Normal"), num("Opacity:", 100, { unit: "%", w: 60 }), chk("Preserve Transparency", false)], ok: "OK", cancel: "Cancel" };
