...
dialogs.levels = { title: "Levels", width: 520, icon: "i-adjust", fields: [sel("Preset:", ["Default", "Increase Contrast", "Lighter", "Darker", "Midtones Brighter"], "Default"), sel("Channel:", ["RGB", "Red", "Green", "Blue"], "RGB"), { type: "histo" }, row(num("", 0, { w: 55 }), num("", 1.0, { w: 55 }), num("", 255, { w: 55 })), row(num("Input Levels:", 0, { w: 55, disabled: true }), lbl("Gamma         "), num("Output:", 255, { w: 55 })), chk("Preview", true)], ok: "OK", cancel: "Cancel" };
dialogs.curves = { title: "Curves", width: 520, icon: "i-paths", fields: [sel("Preset:", ["Default", "Strong Contrast", "Custom"], "Default"), sel("Channel:", ["RGB", "Red", "Green", "Blue"], "RGB"), { type: "curve" }, row(num("Input:", 0, { w: 55 }), num("Output:", 255, { w: 55 })), row({ type: "btn", text: "Smooth" }, { type: "btn", text: "Linear" }, { type: "btn", text: "Reset" }), chk("Preview", true)], ok: "OK", cancel: "Cancel" };
...
dialogs["color-balance"] = { title: "Color Balance", width: 440, fields: [rad("Tone Balance:", ["Shadows", "Midtones", "Highlights"], 1, { inline: true }), chk("Preserve Luminosity", true), { type: "balancebar", left: "Cyan", right: "Red" }, { type: "balancebar", left: "Magenta", right: "Green" }, { type: "balancebar", left: "Yellow", right: "Blue" }, chk("Preview", true)], ok: "OK", cancel: "Cancel" };
dialogs["black-white"] = { title: "Black & White", width: 480, fields: [sel("Preset:", ["Default", "High Contrast Red Filter", "High Contrast Blue Filter", "Infrared"], "Default"), rng("Reds:", 40), rng("Yellows:", 60), rng("Greens:", 40), rng("Cyans:", 60), rng("Blues:", 20), rng("Magentas:", 80), chk("Tint", false), { type: "color", label: "Tint colour", value: "#d8b98a" }, chk("Preview", true)], ok: "OK", cancel: "Cancel" };
dialogs["photo-filter"] = { title: "Photo Filter", width: 430, fields: [rad("", ["Filter", "Color"], 0, { inline: true }), { type: "filterlist", items: ["Warming Filter (85)", "Warming Filter (81)", "Cooling Filter (80)", "Sepia", "Deep Red", "Deep Yellow", "Deep Green", "Deep Blue", "Underwater"] }, { type: "color", label: "Colour", value: "#e8b06a" }, rng("Density:", 25), chk("Preserve Luminosity", true), chk("Preview", true)], ok: "OK", cancel: "Cancel" };
...
dialogs.posterize = { title: "Posterize", width: 340, fields: [num("Levels:", 4, { w: 60 }), chk("Preview", true)], ok: "OK", cancel: "Cancel" };
dialogs.threshold = { title: "Threshold", width: 420, fields: [{ type: "histo" }, num("Threshold Level:", 128, { w: 60, range: [1, 255] }), chk("Preview", true)], ok: "OK", cancel: "Cancel" };
dialogs["gradient-map"] = { title: "Gradient Map", width: 400, fields: [sel("Preset:", ["Black, White", "Blue, Red, Yellow", "Violet, Orange", "Copper", "Custom"], "Black, White"), { type: "gradientbar" }, chk("Dither", true), chk("Reverse", false), chk("Preview", true)], ok: "OK", cancel: "Cancel" };
